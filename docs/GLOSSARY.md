...
Набор записей Φ, поданных в восприятие модели прямо сейчас: постоянный префикс (самые громкие записи по амплитуде) плюс записи, выбранные явными чтениями. Величина меняется от хода к ходу; именно ею управляет модель, выбирая, что прочитать.
**Не путать:** рабочая полоса (J-space) — не наше место и не наша сущность; это полоса слоёв внутри модели, она есть у всякой модели, связывающей шаги. Φ-состояние — то, что мы на эту полосу кладём. «Φ» — регион в файле; «Φ-состояние» — имя состояния, а не третьего региона. Решение владельца 11.09.2026: именно **Φ-состояние**, а не «Φ-space», потому что space — это место, а места у нас нет.
